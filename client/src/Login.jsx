    ...
    const handleRegister = async (e) => {
        ...
        try {
            const res = await fetch('/api/register', {
                ...
                body: JSON.stringify({ username: regUsername, name: regName, email: regEmail, password: regPassword })
            });
            if (res.ok) {
                navigate('/');
            } else {
            ...
            <div className="form">
                {showRegister ? (
                    <form className="register-form" onSubmit={handleRegister}>
                        ...
                        <input type="text" placeholder="*email address" value={regEmail} onChange={e => setRegEmail(e.target.value)} required />
                        ...
                        <p className="message">Already registered? <a href="#" onClick={e => { e.preventDefault(); setShowRegister(false); }}>Sign In</a></p>
                    </form>
                ) : (
